...
class CFGSampler:
    ...
    def _load_model(self):
        ...
        # Create the model using ScoreNetwork
        ...
        # Load the state dict
        self._log.info(f"Loading state dict with {len(model_state)} keys")
